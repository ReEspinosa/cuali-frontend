 ...
 * Cuali — Inicio
 * ---------------------------------------------------------
 * Fase 1 "intro": pantalla completa azul liquid glass con el
 * nombre "Cuali.ai" centrado y animado.
 * Fase 2 "home": el título se encoge y sube a modo header, el
 * fondo pasa de azul a linen, y aparece el saludo + las 4
